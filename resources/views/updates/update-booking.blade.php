...
<div class="content-wrapper">
 ...
 Booking added successfully
   ...
   @endif
      <div class="row mb-8">
        <div class="col-lg-3">
          <h1 class="m-0">Update Room Info</h1>
        </div><!-- /.col -->
     ...
     <div class="offset-lg-2 col-lg-8">
        <div class="card-body p-0">
          <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/update-room" method="post">
              <div class="card-body">
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Booking</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control"  name="room_number" value="{{$room->room_number}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword3" class="col-sm-2 col-form-label" >Cost Of Room</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control"  value="{{$room->price_of_room}}" name="cost_of_room">
                  </div>
                </div>
